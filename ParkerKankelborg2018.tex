...
\begin{abstract}
	...
	Our fit reveals a host of dim lines that alone are insignificant but combined contribute an intensity to the MOSES images comparable to \sixi.
	Combined, lines other than \heii\ and \sixi\ contribute approximately 10 percent to the total intensity of the MOSES zero order image.
...
\section{Introduction}\label{sec:intro}
	...
	\jdp{Taken from the mission paper and slightly edited. Might need a little something.}
...
{           $\boldsymbol{\bigotimes}$};
        ...
        \jdp{think more about normalizing by the std, covariance}
        ...
        \jdp{We might need to call this something, I have to refer to it a ton and it is a mouthful.}  
...
\section{Results}\label{sec:results}
	...
	\begin{figure}
		...
		\caption{The $I_{+1}-I_0$ difference image, also shown in Figure \ref{fig:moses_super}c, along side the same difference image prepared from the synthetic MOSES images of best fit.  Identical regions 1-3 are boxed in each image for comparison. \jdp{add boxes}\jdp{done, will update}}
