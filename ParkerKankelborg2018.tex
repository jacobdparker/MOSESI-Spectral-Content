...
\section{Results}\label{sec:results}
	...
	\begin{table}
		\begin{center}
			\caption{Pixel Dispersion of Dominant Spectral Lines with Intensities Relative to \spectralline{He}{ii}{303.78}.}
			\label{table:disperse}
			%If thesis
%			\input{MOSESI-Spectral-Content/spectral_content}
			%Else
			\input{spectral_content}
	\end{center}
	\end{table}
	\begin{table}
		\begin{center}
	...
	Table \ref{table:disperse} shows the 25 brightest lines observed by MOSES, their intensity relative to \spectralline{He}{ii}{303.78}, and their dispersion in pixels and arcsecond, making it easier to assign spectral content to features in the difference images.
